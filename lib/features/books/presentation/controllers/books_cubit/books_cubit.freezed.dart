...
mixin _$BooksState implements DiagnosticableTreeMixin {
 ...
 TextEditingController get searchController; BooksStateStatus get status; BooksEntity? get books; int get page; String? get errorMessage;
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('searchController', searchController))..add(DiagnosticsProperty('status', status))..add(DiagnosticsProperty('books', books))..add(DiagnosticsProperty('page', page))..add(DiagnosticsProperty('errorMessage', errorMessage));
}
...
@override
int get hashCode => Object.hash(runtimeType,searchController,status,books,page,errorMessage);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'BooksState(searchController: $searchController, status: $status, books: $books, page: $page, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 TextEditingController searchController, BooksStateStatus status, BooksEntity? books, int page, String? errorMessage
});
...
/// Create a copy of BooksState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? searchController = null,Object? status = null,Object? books = freezed,Object? page = null,Object? errorMessage = freezed,}) {
  return _then(_self.copyWith(
searchController: null == searchController ? _self.searchController : searchController // ignore: cast_nullable_to_non_nullable
as TextEditingController,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as BooksStateStatus,books: freezed == books ? _self.books : books // ignore: cast_nullable_to_non_nullable
as BooksEntity?,page: null == page ? _self.page : page // ignore: cast_nullable_to_non_nullable
...
class _BooksState with DiagnosticableTreeMixin implements BooksState {
  const _BooksState({required this.searchController, this.status = BooksStateStatus.initial, this.books, this.page = 1, this.errorMessage});
...
/// Create a copy of BooksState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? searchController = null,Object? status = null,Object? books = freezed,Object? page = null,Object? errorMessage = freezed,}) {
